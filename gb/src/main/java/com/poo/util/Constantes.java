...
public class Constantes {
    public static final String ARQUIVO_COMPUTACAO = "computation.txt";
    public static final String ARQUIVO_FILA = "fila.dat";
    public static final String OPERADOR_ADICAO = "+";
